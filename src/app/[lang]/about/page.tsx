...
export default async function AboutPage({ params }: PageProps) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-russo text-accent-yellow text-center mb-12">{dict.about_page.title}</h1>

      <section className="mb-12">
        <h2 className="text-3xl font-russo  text-text-light mb-6 text-center">{dict.about_page.our_story}</h2>
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-russo text-text-light mb-6 text-center">{dict.about_page.meet_founders}</h2>
      ...
      <section>
        <h2 className="text-3xl font-russo text-text-light mb-6 text-center">{dict.about_page.our_actors_coaches}</h2>
