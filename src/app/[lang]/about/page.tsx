...
export default async function AboutPage({ params: { lang } }: { params: { lang: 'en' | 'ua' } }) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold text-accent-yellow text-center mb-12">{dict.about_page.title}</h1>
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-text-light mb-6 text-center">{dict.about_page.meet_founders}</h2>
